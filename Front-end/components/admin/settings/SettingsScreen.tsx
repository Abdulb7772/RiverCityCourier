...
import { fetchProfile, type AdminProfile } from '@/lib/admin-profile';
...
export function SettingsScreen({ userEmail, userName }: SettingsScreenProps) {
  ...
  const handleSidebarSelect = useCallback(
    (item: string) => {
      ...
      const paths: Record<string, string> = {
        ...
        Reviews: '/admin/reviews', Profile: '/admin/profile',
      };
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(249,115,22,0.34),transparent_22%),radial-gradient(circle_at_top_right,rgba(251,146,60,0.14),transparent_18%),linear-gradient(180deg,#2b1606_0%,#0f172a_52%,#020617_100%)] text-white">
      ...
      <AdminNavbar
        userEmail={userEmail}
        userName={userName}
        summaryText="Manage your account security, username, and email address."
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-7.5 text-orange-400/60 hover:text-orange-300"
                  >
